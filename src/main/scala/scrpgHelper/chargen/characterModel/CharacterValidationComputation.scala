...
/** Character validation computation - pure functions for computing validation results.
  *
  * This object contains all the business logic for validating character data
  * from character state and staging data. All methods are pure functions that
  * take explicit parameters and return computed validation results without side effects.
  */
object CharacterValidationComputation:
  ...
  /** Validate background selection and related staging data.
    ...
    */
  def validateBackground(data: CharacterData): Boolean =
  ...
  /** Validate power source selection and related staging data.
    ...
    */
  def validatePowerSource(data: CharacterData): Boolean =
  ...
  /** Validate archetype selection and related staging data.
    ...
    */
  def validateArchetype(data: CharacterData): Boolean =
  ...
  /** Validate personality selection and related staging data.
    ...
    */
  def validatePersonality(data: CharacterData): Boolean =
  ...
  /** Validate red abilities selection and completion.
    ...
    */
  def validateRedAbilities(data: CharacterData): Boolean =
    val selectedAbilities = data.abilityStaging
  ...
  /** Validate health value is set.
    ...
    */
  def validateHealth(data: CharacterData): Boolean =
    data.health.isDefined

end CharacterValidationComputation